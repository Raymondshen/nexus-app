...
| Manage Profile / ManageSquadProfile — photo/bg upload | `Upload` | 16×16, `--color-purple` |
...
| ChatRoomBrowseSheet — leave | `DoorClosed` | 16×16 |
| ChatRoomBrowseSheet — invite code copy | `Copy` / `Check` | 12×12, `--color-primary` |
