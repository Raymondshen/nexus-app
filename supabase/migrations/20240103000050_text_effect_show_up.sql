-- Replace letters_pull_up/blur_in with show_up in the allowed text_effect set
...
alter table squad_definitions add constraint squad_definitions_text_effect_check
  check (text_effect is null or text_effect = any (array['bouncy_text'::text, 'show_up'::text]));
