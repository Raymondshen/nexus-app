...
- Inline definition keyword highlight (`renderWithDefinitions`): `--color-primary`, font-weight 500 (medium), wraps `TextEffectText` for the word's `text_effect`.
