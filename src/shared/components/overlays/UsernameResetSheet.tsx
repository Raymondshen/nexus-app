      ...
      {visible && (
        <BottomSheet onClose={() => {}} disableDrag zIndex={95}>
          ...
          >
            ...
            >
              <p
                className="font-silkscreen text-tertiary leading-none whitespace-nowrap"
                style={{ fontSize: "var(--mini)" }}
              >
                Sorry! We apologize...
              </p>
              <div
                className="flex flex-col items-start w-full leading-none"
                style={{ gap: "var(--x2)" }}
              >
                <p
                  className="font-body font-bold text-primary w-full"
                  style={{
                    fontSize: "var(--md)",
                ...
                >
                  Your previous username used characters we no longer support
                  (spaces, punctuation, etc). Please choose a new one.
                </p>
              </div>
            </div>
            ...
            >
              ...
              {error && (
                <p
                  ...
                  style={{ fontSize: "var(--xxs)", color: "var(--red)" }}
                >
                  {error}
                </p>
              )}
