  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 px-4">
        <div
          className="flex items-center border border-border px-4 py-4"
          style={{ gap: 16 }}
        >
          <Search
            style={{
      ...
      <div
        ...
        style={{ minHeight: 0, paddingBottom: 28 }}
      >
        {error ? (
          <div className="flex flex-col items-center justify-center py-12 gap-4">
            <p className="font-silkscreen text-[8px] text-tertiary leading-relaxed text-center">
              {error}
            </p>
            <button
          ...
          <div className="flex items-center justify-center py-12">
            <p className="font-silkscreen text-[8px] text-tertiary">
              No GIFs found
            </p>
          </div>
        ) : (
          ...
          >
            ...
            {loading &&
              gifs.length === 0 &&
              Array.from({ length: KLIPY_PAGE_SIZE }).map((_, i) => (
                <div
                  key={`sk-${i}`}
