...
export type Database = {
  public: {
    Tables: {
      profiles: {
        Row: Profile
        Insert: Omit<Profile, 'created_at' | 'avatar_url' | 'coins' | 'custom_avatar' | 'gem_balance' | 'last_gem_claim' | 'is_dev' | 'needs_username_reset' | 'onboarding_completed' | 'instagram_url' | 'x_url' | 'reddit_url' | 'linkedin_url' | 'custom_site_url' | 'pinned_crew_id'> & { created_at?: string; avatar_url?: string | null; coins?: number; custom_avatar?: boolean; gem_balance?: number; last_gem_claim?: string | null; is_dev?: boolean; needs_username_reset?: boolean; onboarding_completed?: boolean; instagram_url?: string | null; x_url?: string | null; reddit_url?: string | null; linkedin_url?: string | null; custom_site_url?: string | null; pinned_crew_id?: string | null }
